...
computes the ground track of a satellite given including the nodal precession
...
## Declaration
```matlab
 [lat, lon] = computeGroundTrackWithNodalPrecession(semi_major_axis, e, incl, RAAN_0, omega, M0, t)
```
## Parameters
